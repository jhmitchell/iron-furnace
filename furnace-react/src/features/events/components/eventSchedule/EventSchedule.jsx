...
import { getAllEvents, groupEventsByYearAndMonth } from "../../services/eventService";
...
const EventSchedule = () => {
	...
	const eventsByYearAndMonth = groupEventsByYearAndMonth(events);

	return (
		<div className={styles.eventSchedule}>
			{Array.from(eventsByYearAndMonth.entries()).map(([year, monthMap]) => (
