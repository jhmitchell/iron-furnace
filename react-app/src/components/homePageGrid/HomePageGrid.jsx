  ...
  return (
    <div className="homePageContent">
      <div className="homePageContentLeft">
        ...
        <p>
          Located in southern Lebanon County, Cornwall Iron Furnace is an
          extraordinary example of the furnaces that dotted the Pennsylvania
          countryside in the 18th and 19th centuries. Around it developed
          villages, artisans' shops, stores, schools, churches, and, of course,
          the homes of the ironmasters, managers, and workers.
        </p>
        <p>
          Today, the Furnace stands as a symbol of Pennsylvania's industrial
          heritage and a tribute to the workers who helped make America a great
          industrial nation.
        </p>
      </div>
